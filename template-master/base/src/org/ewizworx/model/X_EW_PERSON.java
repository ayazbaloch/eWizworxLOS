...
public class X_EW_PERSON extends PO implements I_EW_PERSON, I_Persistent 
{
    ...
    {
		return (org.ewizworx.model.I_EW_GREETING)MTable.get(getCtx(), org.ewizworx.model.I_EW_GREETING.Table_Name)
	...
	{
		throw new IllegalArgumentException ("Full_Name is virtual column");	}
