...
/** Generated Model for COL_COUNTRY
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_COL_COUNTRY extends PO implements I_COL_COUNTRY, I_Persistent 
{
    ...
    public X_COL_COUNTRY (Properties ctx, int COL_COUNTRY_ID, String trxName)
    {
      super (ctx, COL_COUNTRY_ID, trxName);
      /** if (COL_COUNTRY_ID == 0)
        {
			setCOL_COUNTRY_ID (0);
			setCountryCode (null);
    ...
    /** Load Constructor */
    public X_COL_COUNTRY (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_COL_COUNTRY[")
	...
	{
		if (COL_COUNTRY_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_COL_COUNTRY_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_COL_COUNTRY_ID, Integer.valueOf(COL_COUNTRY_ID));
	}
