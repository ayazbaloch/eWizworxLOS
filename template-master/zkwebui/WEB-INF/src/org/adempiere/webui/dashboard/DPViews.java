...
public class DPViews extends DashboardPanel implements EventListener {
	...
	private Box createViewPanel()
	{
		...
		if (MRole.getDefault().isAllow_Info_Asset())
		{
			...
			ToolBarButton btnViewItem1 = new ToolBarButton("InfoBranch");
			btnViewItem1.setLabel(Util.cleanAmp(Msg.getMsg(Env.getCtx(), "InfoBranch")));
			btnViewItem1.setImage(ITheme.IMAGE_FOLDER_DARK + "Info16.png");
			btnViewItem1.addEventListener(Events.ON_CLICK, this);
			vbox.appendChild(btnViewItem1);
    ...
    public void onEvent(Event event)
    {
        ...
        if(eventName.equals(Events.ON_CLICK))
        {
            if(comp instanceof ToolBarButton)
            {
        		...
        		else if (actionCommand.equals("InfoBranch") && AEnv.canAccessInfo("RESOURCE"))
        		{
        			InfoBranchPanel.showBranch(WindowNo,  "");
        		}
            }
        }
	}
